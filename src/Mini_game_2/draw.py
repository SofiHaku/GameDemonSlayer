...
class draw():
    ...
    def __init__(self, screen):
        ...
        self.image_back = pygame.image.load("assets/Mini_game_2/back2.png")
        self.image_back_rect = self.image_back.get_rect()
        self.image_back_rect.x = self.globals.START_X

        self.image_road1 = pygame.image.load("assets/Mini_game_2/road.png")
        ...
        self.image_road2 = pygame.image.load("assets/Mini_game_2/road.png")
        ...
        self.image_tap = pygame.image.load("assets/Mini_game_2/tap_to_play.png")
