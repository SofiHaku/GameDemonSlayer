...
class menu():
    ...
    def make_small_surface(self, i, j, mini_surf_one, globals):
        ...
        any_surf_one.y = 2
        if (i % 2) == 0:
            any_surf_one.img = pygame.image.load("assets/menu/earring.png")
        else:
            any_surf_one.img = pygame.image.load("assets/menu/mask.png")
